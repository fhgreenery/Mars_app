package com.sjzc.fh.pedometer.utils;
...
public class OtherUtil {
    ...
    public static boolean hasLogin(){
        ...
        if(TextUtils.equals("yes", App.aCache.getAsString("has_login"))){
            isLogin = true;
        }else{
            isLogin = false;
        }
    ...
    private static void showNewToast(Context context, int resId, CharSequence text, int duration) {
        ...
        View layout = inflater.inflate(com.sjzc.fh.pedometer.R.layout.custom_toast, null);
        ImageView imageView = (ImageView) layout.findViewById(com.sjzc.fh.pedometer.R.id.iv_icon);
        TextView textView = (TextView) layout.findViewById(com.sjzc.fh.pedometer.R.id.tv_content);
        if (resId > 0) {
