package com.sjzc.fh.pedometer.ui.weather;
...
import com.sjzc.fh.pedometer.entity.Forecast;
import com.sjzc.fh.pedometer.entity.Weather;
import com.sjzc.fh.pedometer.widget.ScalePageTransformer;
...
public class WeatherActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        String location = "石家庄";
               // aCache.getAsString("location_city");
        if(TextUtils.isEmpty(location)){
            Toast.makeText(this, "未获取到位置信息", Toast.LENGTH_SHORT).show();
            return;
        }
        StringBuilder urlSb = new StringBuilder();
        String url = urlSb.append(urlprefix).append("&location=").append(location).append("&ak=").append("tTPUoUgnb0BO9f9VEGtwLDclBmExPFEU").append("&mcode=").append("03:4F:6A:06:11:27:02:23:D0:85:7D:4E:CE:22:F3:1E:E0:E6:8A:41;com.wulee.administrator.zuji").toString();        //String url = urlSb.append(urlprefix).append("&location=").append(location).append("&ak=").append("ijmcunz4K2rnZD3d461ZmSMohgHWqrgN").append("&mcode=").append("ED:14:12:07:42:7C:97:B2:9F:3B:E3:B3:7E:9B:43:5C:5E:FE:F0:73;com.sjzc.fh.pedometer").toString();
