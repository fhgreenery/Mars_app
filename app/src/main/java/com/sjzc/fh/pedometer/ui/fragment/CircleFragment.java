...
import com.sjzc.fh.pedometer.adapter.CircleContentAdapter;
import com.sjzc.fh.pedometer.database.bean.PersonInfo;
import com.sjzc.fh.pedometer.entity.CircleComment;
import com.sjzc.fh.pedometer.entity.CircleContent;
import com.sjzc.fh.pedometer.entity.Constant;
import com.sjzc.fh.pedometer.ui.LoginActivity;
import com.sjzc.fh.pedometer.ui.PersonalInfoActivity;
import com.sjzc.fh.pedometer.ui.PublishCircleActivity;
import com.sjzc.fh.pedometer.utils.AppUtils;
import com.sjzc.fh.pedometer.utils.FileProvider7;
...
import com.sjzc.fh.pedometer.widget.RecycleViewDivider;
                ...
                query.findObjects(new FindListener<PersonInfo>() {
                    ...
                    public void done(List<PersonInfo> list, BmobException e) {
                        if (e == null) {
                            ...
                            LogUtil.i("Sports on Mars", "失败：" + e.getMessage());
                        }
                    }
                });
            }
