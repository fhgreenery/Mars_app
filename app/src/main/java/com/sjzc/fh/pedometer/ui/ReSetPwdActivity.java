...
public class ReSetPwdActivity extends BaseActivity implements View.OnClickListener{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(com.sjzc.fh.pedometer.R.layout.reset_pwd);
    ...
    private void initView() {
        mEtMobile = (EditText) findViewById(com.sjzc.fh.pedometer.R.id.et_mobile);
        mEtPwd = (EditText) findViewById(com.sjzc.fh.pedometer.R.id.et_new_pwd);
        mEtPincode = (EditText) findViewById(com.sjzc.fh.pedometer.R.id.et_pincode);
        mBtnPincode = (Button) findViewById(com.sjzc.fh.pedometer.R.id.btn_pincode);
        mBtnReSetPwd = (Button) findViewById(com.sjzc.fh.pedometer.R.id.btn_reset_pwd);
    }

    @Override
    public void onClick(View view) {
        switch (view.getId()){
            case com.sjzc.fh.pedometer.R.id.btn_reset_pwd:
