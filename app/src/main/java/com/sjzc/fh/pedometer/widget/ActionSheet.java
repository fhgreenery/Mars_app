...
public class ActionSheet extends Dialog implements OnClickListener {
    ...
    private Attributes readAttribute() {
        ...
        TypedArray a = mContext.getTheme().obtainStyledAttributes(null, com.sjzc.fh.pedometer.R.styleable.ActionSheet,
                com.sjzc.fh.pedometer.R.attr.actionSheetStyle, 0);
        Drawable background = a.getDrawable(com.sjzc.fh.pedometer.R.styleable.ActionSheet_actionSheetBackground);
        if (background != null)
            attrs.background = background;
        Drawable cancelButtonBackground = a.getDrawable(com.sjzc.fh.pedometer.R.styleable.ActionSheet_cancelButtonBackground);
        if (cancelButtonBackground != null)
            attrs.cancelButtonBackground = cancelButtonBackground;
        Drawable otherButtonTopBackground = a.getDrawable(com.sjzc.fh.pedometer.R.styleable.ActionSheet_otherButtonTopBackground);
        ...
        Drawable otherButtonMiddleBackground = a
                .getDrawable(com.sjzc.fh.pedometer.R.styleable.ActionSheet_otherButtonMiddleBackground);
        ...
        Drawable otherButtonBottomBackground = a
                .getDrawable(com.sjzc.fh.pedometer.R.styleable.ActionSheet_otherButtonBottomBackground);
        ...
        Drawable otherButtonSingleBackground = a
                .getDrawable(com.sjzc.fh.pedometer.R.styleable.ActionSheet_otherButtonSingleBackground);
        if (otherButtonSingleBackground != null)
            attrs.otherButtonSingleBackground = otherButtonSingleBackground;
        attrs.cancelButtonTextColor = a.getColor(com.sjzc.fh.pedometer.R.styleable.ActionSheet_cancelButtonTextColor,
                attrs.cancelButtonTextColor);
        attrs.otherButtonTextColor = a.getColor(com.sjzc.fh.pedometer.R.styleable.ActionSheet_otherButtonTextColor,
                attrs.otherButtonTextColor);
        attrs.padding = (int) a.getDimension(com.sjzc.fh.pedometer.R.styleable.ActionSheet_actionSheetPadding, attrs.padding);
        attrs.otherButtonSpacing = (int) a.getDimension(com.sjzc.fh.pedometer.R.styleable.ActionSheet_otherButtonSpacing,
                attrs.otherButtonSpacing);
        attrs.cancelButtonMarginTop = (int) a.getDimension(com.sjzc.fh.pedometer.R.styleable.ActionSheet_cancelButtonMarginTop,
                attrs.cancelButtonMarginTop);
        attrs.actionSheetTextSize = a.getDimensionPixelSize(com.sjzc.fh.pedometer.R.styleable.ActionSheet_actionSheetTextSize,
