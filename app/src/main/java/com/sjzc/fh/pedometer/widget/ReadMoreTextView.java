...
public class ReadMoreTextView extends AppCompatTextView {
    ...
    public ReadMoreTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.sjzc.fh.pedometer.R.styleable.ReadMoreTextView);
        this.trimLength = typedArray.getInt(com.sjzc.fh.pedometer.R.styleable.ReadMoreTextView_trimLength, DEFAULT_TRIM_LENGTH);
        int resourceIdTrimCollapsedText =
                typedArray.getResourceId(com.sjzc.fh.pedometer.R.styleable.ReadMoreTextView_trimCollapsedText, com.sjzc.fh.pedometer.R.string.read_more);
        int resourceIdTrimExpandedText =
                typedArray.getResourceId(com.sjzc.fh.pedometer.R.styleable.ReadMoreTextView_trimExpandedText, com.sjzc.fh.pedometer.R.string.read_less);
        ...
        this.trimLines = typedArray.getInt(com.sjzc.fh.pedometer.R.styleable.ReadMoreTextView_trimLines, DEFAULT_TRIM_LINES);
        this.colorClickableText = typedArray.getColor(com.sjzc.fh.pedometer.R.styleable.ReadMoreTextView_colorClickableText,
                ContextCompat.getColor(context, com.sjzc.fh.pedometer.R.color.colorAccent));
        this.showTrimExpandedText =
                typedArray.getBoolean(com.sjzc.fh.pedometer.R.styleable.ReadMoreTextView_showTrimExpandedText, DEFAULT_SHOW_TRIM_EXPANDED_TEXT);
        this.trimMode = typedArray.getInt(com.sjzc.fh.pedometer.R.styleable.ReadMoreTextView_trimMode, TRIM_MODE_LINES);
        typedArray.recycle();
