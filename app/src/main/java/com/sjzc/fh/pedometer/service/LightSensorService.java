...
import com.sjzc.fh.pedometer.widget.ChartView;
...
public class LightSensorService extends Service implements SensorEventListener {
	...
	public void onCreate() {
		...
		cvLight.setMstyle(ChartView.Mstyle.Line);
*/
		// cvLight.draw(canvas);
	...
	public void onSensorChanged(SensorEvent event) {
		...
		synchronized (this) {
			if (sensor.getType() == Sensor.TYPE_LIGHT) {
				...
				/*StepActivity.tvLight.setText(getString(R.string.light_curve_head)
						+ LightSensorService.LIGHT);
						*/
				Log.i(TAG, LIGHT + "");

//				if (LIGHT < StepActivity.LIGHT_BORDER) {
//					isInPocket = true;
//				} else {
//					isInPocket = false;
//				}
