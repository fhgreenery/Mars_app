...
import com.sjzc.fh.pedometer.adapter.PublishPicGridAdapter;
import com.sjzc.fh.pedometer.database.bean.PersonInfo;
import com.sjzc.fh.pedometer.entity.CircleContent;
import com.sjzc.fh.pedometer.entity.PublishPicture;
...
import com.sjzc.fh.pedometer.widget.AnFQNumEditText;
...
public class PublishCircleActivity extends TakePhotoActivity {
    ...
    private void publishCircleContent() {
        ...
        if (mType == TYPE_PUBLISH_TEXT_AND_IMG) {
            ...
            circlrContent.setUserNick(TextUtils.isEmpty(piInfo.getName()) ? "用户" : piInfo.getName());
