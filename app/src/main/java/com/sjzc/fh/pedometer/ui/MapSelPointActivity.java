...
public class MapSelPointActivity extends BaseActivity implements OnGetGeoCoderResultListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.sjzc.fh.pedometer.R.layout.map_sel_point);
        /**
         * 初始化搜索模块，注册事件监听
         */
         ...
         */
        //获取百度地图控件
        mapView = (MapView) findViewById(com.sjzc.fh.pedometer.R.id.bmapView);
        //获取百度地图对象
    ...
    public void onGetGeoCodeResult(GeoCodeResult result) {
        ...
        baiduMap.addOverlay(new MarkerOptions().position(result.getLocation())
                .icon(BitmapDescriptorFactory
                        .fromResource(com.sjzc.fh.pedometer.R.mipmap.icon_mark)));
    ...
    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult result) {
        ...
        baiduMap.addOverlay(
                new MarkerOptions()
                        ...
                        .icon(BitmapDescriptorFactory.fromResource(com.sjzc.fh.pedometer.R.mipmap.icon_mark))  //图标
