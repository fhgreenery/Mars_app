...
public class CoolImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    {
        TypedArray a =context.obtainStyledAttributes(attrs, com.sjzc.fh.pedometer.R.styleable.CoolImageView);
        String direction=a.getString(com.sjzc.fh.pedometer.R.styleable.CoolImageView_direction);
        if(direction==null)
        {
